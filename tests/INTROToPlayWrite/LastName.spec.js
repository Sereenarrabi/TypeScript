...
test_1.test.describe('Lastname Validation ', () => {
    let browser;
    let page;
    ...
    (0, test_1.test)(`with special characters lastname input should show error message: '${expectedErrorMessage}'`, () => __awaiter(void 0, void 0, void 0, function* () {
        const input = page.locator(LASTNAME_INPUT_LOCATOR);
    ...
    (0, test_1.test)(`with digits characters lastname input should show error message: '${expectedErrorMessage}'`, () => __awaiter(void 0, void 0, void 0, function* () {
        const input = page.locator(LASTNAME_INPUT_LOCATOR);
        yield input.fill('aaaa123');
        yield page.locator(SUBMIT_BUTTON_LOCATOR).click();
        const errorMsg = yield page.locator(ERROR_LABEL_LOCATOR).textContent();
        (0, test_1.expect)(errorMsg).toBe(expectedErrorMessage);
    }));
