...
test_1.test.describe('FirstName Validation ', () => {
    let browser;
    let page;
    ...
    (0, test_1.test)(`with special characters firstname input should show error message: '${expectedErrorMessage}'`, () => __awaiter(void 0, void 0, void 0, function* () {
        const input = page.locator(FIRSTNAME_INPUT_LOCATOR);
        yield input.fill('aaaaaa@@');
        yield page.locator(SUBMIT_BUTTON_LOCATOR).click();
        const errorMsg = yield page.locator(ERROR_LABEL_LOCATOR).textContent();
        (0, test_1.expect)(errorMsg).toBe(expectedErrorMessage);
    }));
    (0, test_1.test)(`with digits characters firstname input should show error message: '${expectedErrorMessage}'`, () => __awaiter(void 0, void 0, void 0, function* () {
        const input = page.locator(FIRSTNAME_INPUT_LOCATOR);
        yield input.fill('vfujyt9');
        yield page.locator(SUBMIT_BUTTON_LOCATOR).click();
        const errorMsg = yield page.locator(ERROR_LABEL_LOCATOR).textContent();
        (0, test_1.expect)(errorMsg).toBe(expectedErrorMessage);
    }));
